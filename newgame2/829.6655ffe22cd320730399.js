  ...
  [829], {
    ...
    5595: function (e, t, n) {
      ...
      const i = "bb-tower-session-holder-id",
        ...
        g = (0, r.createStore)(null).on(p.doneData, (e, t) => t).reset([l, m]),
        x = (0, r.createStore)(null).on(l.failData, (e, t) => t).on(c.failData, (e, t) => t).on(d.failData, (e, t) => t).on(f.failData, (e, t) => t).on(p.failData, (e, t) => t).reset([l, p]);
      l.doneData.watch(e => {
